 ...
 */
package org.apache.camel.example.springboot.route;
...
public class CamelRouter extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        // @formatter:off
    	onException(AccessDeniedException.class).handled(true).transform().simple("access denied").setHeader(Exchange.HTTP_RESPONSE_CODE, constant(403))
        .to("mock:handled");
        ...
        rest("/google").get().to("https://www.google.com/search?q=test&bridgeEndpoint=true&amp;throwExceptionOnFailure=false");
